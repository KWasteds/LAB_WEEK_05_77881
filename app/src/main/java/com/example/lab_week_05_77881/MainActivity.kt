...
import com.example.lab_week_05_77881.api.CatApiService
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response
import com.example.lab_week_05_77881.model.ImageData
import android.widget.ImageView
import com.example.lab_week_05_77881.GlideLoader
import com.example.lab_week_05_77881.ImageLoader
        ...
        call.enqueue(object: Callback<List<ImageData>> {
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    // Ambil nama breed kalau ada, kalau tidak "Unknown"
